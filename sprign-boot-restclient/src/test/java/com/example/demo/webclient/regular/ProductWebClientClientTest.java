...
import com.example.demo.webclient.regular.ProductWebClientClient;
...
class ProductWebClientClientTest {
    private final BasicJsonTester jsonTester = new BasicJsonTester(getClass());
    private ProductWebClientClient client;
    ...
    void setUp() throws IOException {
        ...
        client = new ProductWebClientClient(webClient);
    }
